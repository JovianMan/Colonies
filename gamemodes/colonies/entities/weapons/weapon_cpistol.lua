...
function SWEP:Initialize()
    ...
    killicon.Add( "weapon_cpistol", "", color_white ) --aimbot/killico
    end
...
function SWEP:PrimaryAttack()
    ...
    self.Weapon:EmitSound( Sound("weapons/pistol/pistol_fire2.wav") )
...
function SWEP:DrawWeaponSelection(x,y,wide,tall,alpha)
    draw.SimpleText("Pistol","Arial",x + wide/2,y + tall*0.35,team.GetColor( LocalPlayer():Team() ),TEXT_ALIGN_CENTER) -- is this right?
end